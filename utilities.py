...
async def fetch_attachments(page_url):
    ...
    final_links = season_based_links if season_based_links else (highest_episode_links if highest_episode_links else links)
...
async def root_route_handler(request):
    return web.json_response("HeartxBotz")
